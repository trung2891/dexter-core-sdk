...
import {InstantiateMsg, MinterResponse, ExecuteMsg, QueryMsg, MigrateMsg, AllAccountsResponse, AllAllowancesResponse, AllSpenderAllowancesResponse, AllowanceResponse, BalanceResponse, DownloadLogoResponse, MarketingInfoResponse, TokenInfoResponse} from "./LpToken.types";
export interface LpTokenReadOnlyInterface {
...
export class LpTokenQueryClient implements LpTokenReadOnlyInterface {
...
export interface LpTokenInterface extends LpTokenReadOnlyInterface {
  contractAddress: string;
  sender: string;
  transfer: ({
    amount,
...
export class LpTokenClient extends LpTokenQueryClient implements LpTokenInterface {
