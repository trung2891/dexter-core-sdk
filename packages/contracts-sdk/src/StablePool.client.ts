...
export interface StablePoolInterface extends StablePoolReadOnlyInterface {
  contractAddress: string;
  sender: string;
  updateConfig: ({
    params
...
export class StablePoolClient extends StablePoolQueryClient implements StablePoolInterface {
